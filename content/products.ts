...
export type ProductStatus = "development" | "available" | "research" | "classified";
    ...
    views: [
      {
        ...
        label: "Front",
        code: "R3-F",
        src: "/images/tech-schematic-960.avif",
        width: 960,
        height: 960,
      },
      {
        ...
        label: "Side",
        code: "R3-S",
        src: "/images/tech-schematic-side-960.avif",
        width: 960,
        height: 960,
      },
      {
        ...
        label: "Cutaway",
        code: "R3-X",
        src: "/images/tech-schematic-cutaway-960.avif",
        width: 960,
        height: 960,
      },
    ],
...
/** Programs shown on the index but without a public detail page. */
export const classifiedPrograms = [
  {
    code: "R4",
    name: "AnthRo R4",
